...
export const TRANSLATIONS: Record<Language, Translation> = {
  [Language.ES]: {
    ...
    checkOut: "Salida",
    folio: "Folio",
    timeshareNo: "Timesharew No.",
    startDate: "Desde",
    endDate: "Hasta",
    exportCSV: "Exportar a CSV",
    ofTotal: "del total",
    topExpenses: "Top Gastos y Descuentos",
    total: "Total"
  },
  [Language.EN]: {
    ...
    ofTotal: "of total",
    topExpenses: "Top Expenses & Discounts",
    total: "Total"
  }
};
...
export const EXCHANGE_RATE_EUR_TO_MXN = 18.50; // Example static rate
export const EXCHANGE_RATE_MXN_TO_EUR = 0.054; // Example static rate
export const EXCHANGE_RATE_CAD_TO_MXN = 12.60; // Example static rate
export const EXCHANGE_RATE_MXN_TO_CAD = 0.079; // Example static rate